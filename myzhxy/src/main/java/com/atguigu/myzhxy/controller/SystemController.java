...
// put some common functions in this class
...
public class SystemController {
    ...
    * */
    ...
    @ApiOperation("obtain information about the current login user using the token password")
    @GetMapping("/getInfo")
    ...
    @GetMapping("/getVerifiCodeImage") //@GetMapping是一个组合注解，是@RequestMapping(method = RequestMethod.GET)的缩写。
    public void getVerifiCodeImage(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            //  ImageIO is an util to help us write picture
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
